    ...
    <div className="min-h-screen flex flex-col lg:flex-row font-geist">
      ...
      {heroImageSrc && (
        <section className="hidden lg:block flex-1 relative p-4">
          <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-right opacity-75" style={{ backgroundImage: `url(${heroImageSrc})` }}></div>

    ...
    <div className="min-h-screen flex flex-col lg:flex-row font-geist bg-transparent">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-secura-teal transition-colors">Reset password</a>
              </div>
      ...
      {heroImageSrc && (
        <section className="hidden lg:block flex-1 relative p-4">
          <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-left" style={{ backgroundImage: `url(${heroImageSrc})` }}></div>
